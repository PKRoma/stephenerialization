...
public class CyclicB implements Serializable {
	 ...
	 *            the cyclic to set
	 */
	public void setCyclic(CyclicA cyclic) {
		this.cyclic = cyclic;
	}
	...
	private void writeObject(ObjectOutputStream streamer) {
		...
		service.stephenerialize(this, streamer, CyclicB.class);
	}
